...
MainWindow::MainWindow(Editor &editor) : m_Editor(editor), m_QuitFlag(false) {
  int rows, cols;
...
void MainWindow::Clear() { m_Window->Clear(); }
...
void MainWindow::Refresh() { m_Window->Refresh(); }
